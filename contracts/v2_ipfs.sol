...
contract Certification {
    ...
    function generateCertificate(string memory _id,string memory _candidate_name,string memory _org_name, string memory _course_name, uint256 _expiration_date,string memory _ipfsLink) public {
        ...
        certificates[byte_id] = Certificate(_candidate_name, _org_name, _course_name, _expiration_date, _ipfsLink);
    ...
    function getData(string memory _id) public view returns(string memory, string memory, string memory, uint256, string memory) {
        ...
        return (temp.candidate_name, temp.org_name, temp.course_name, temp.expiration_date, temp.ipfsLink);
    }
}
